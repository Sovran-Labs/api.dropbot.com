import erc20_abi from '@/src/temporal/activities/flow7a/abis/erc20.json';
import vault from '@/src/temporal/activities/flow7a/abis/vault.json';
import { JsonRpcProvider } from 'ethers';
import router_abi from '@/src/temporal/activities/flow7a/abis/router.json';
import classic_pair_abi from '@/src/temporal/activities/flow7a/abis/classicPool.json';
import stable_pair_abi from '@/src/temporal/activities/flow7a/abis/stablePool.json';
import classic_pair_factory_abi from '@/src/temporal/activities/flow7a/abis/classicPoolFactory.json';
import stable_pair_factory_abi from '@/src/temporal/activities/flow7a/abis/stablePoolFactory.json';
