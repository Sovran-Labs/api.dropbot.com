import { Token, Pool } from '@/src/temporal/activities/flow7c/helpers/types';
...
import {
  ...
  CLASSIC_POOL_ABI,
} from '@/src/temporal/activities/flow7c/helpers/config/constants';
import Tokens from '@/src/temporal/activities/flow7c/helpers/config/tokens';
import assert from 'assert';

export const get_token = async (tokenAddress: string, network: 'TESTNET' | 'MAINNET'): Promise<Token> => {
  // const tokenConfig = Object.values(Tokens[network]).find((token: Token) => {
